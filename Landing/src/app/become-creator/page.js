        ...
        <section className="relative table w-full py-32 bg-gray-50 dark:bg-slate-800">
                <div className="container">
                    <div className="grid lg:grid-cols-12 grid-cols-2 pb-8 mt-10 gap-[30px] items-center">
                        <div className="lg:col-span-4">
                            <Image src='/images/creator.png' placeholder="blur" blurDataURL='/images/creator.png'  alt="" width={0} height={0} sizes="100vw" style={{width:"100%", height:"auto"}}  />
                        </div>
                ...
                <div className="absolute text-center z-10 bottom-5 start-0 end-0 mx-3">
                    <ul className="breadcrumb tracking-[0.5px] mb-0 inline-block">
                        <li className="inline breadcrumb-item text-[15px] font-semibold duration-500 ease-in-out hover:text-violet-600"><Link href="/index">Giglink</Link></li>
                                    ...
                                    <form>
                                        <div className="grid grid-cols-1 gap-6">
                                            ...
                                            <div className="text-start">
                                                ...
                                                <input name="url" id="giglink-url" type="url" className="form-input w-full text-[15px] py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-full outline-none border border-gray-200 focus:border-violet-600 dark:border-gray-800 dark:focus:border-violet-600 focus:ring-0 mt-2" value="https://giglink.exe/streetboyyy" />
                                            </div>
