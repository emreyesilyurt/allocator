                                    ...
                                    <div className="grid lg:grid-cols-12 lg:gap-6">
                                        <div className="lg:col-span-6 mb-5">
                                            <div className="text-start">
                                                ...
                                                <div className="form-icon relative mt-2">
                                                    <User className="size-4 absolute top-3 start-4"></User>
                                        ...
                                        <div className="lg:col-span-6 mb-5">
                                            <div className="text-start">
                                                ...
                                                <div className="form-icon relative mt-2">
                                                    <Mail className="size-4 absolute top-3 start-4"></Mail>
                                    ...
                                    <div className="grid grid-cols-1">
                                        <div className="mb-5">
                                            <div className="text-start">
                                                ...
                                                <div className="form-icon relative mt-2">
                                                    <Book className="size-4 absolute top-3 start-4"></Book>
                                        ...
                                        <div className="mb-5">
                                            <div className="text-start">
                                                ...
                                                <div className="form-icon relative mt-2">
                                                    <MessageCircle className="size-4 absolute top-3 start-4"></MessageCircle>
                        ...
                        {helpData.map((item, index)=>{
                            ...
                            return(
                                ...
                                <div className="content mt-7">
                                    <Link href="/helpcenter-faqs" className="title h5 text-lg font-semibold hover:text-violet-600">{item.title}</Link>
                                    <p className="text-slate-400 mt-3">{item.description}</p>
    
                                    <div className="mt-5">
                                        <Link href="/helpcenter-faqs" className="btn btn-link text-violet-600 hover:text-violet-600 after:bg-violet-600 duration-500 ease-in-out inline-flex items-center"><span>Read More </span><MdOutlineArrowForward className="ms-1 text-base"/></Link>
                                    </div>
                                </div>
                            </div>
                            )
