...
className={`flex justify-between items-center p-5 w-full font-semibold text-start rounded-md border border-gray-100 dark:border-white/10 bg-white dark:bg-[#101010] ${
    activeIndex === index ? 'text-violet-600' : 'text-black dark:text-white'
  }`}
