    ...
    return (
        <div className="container lg:mt-24 mt-16">
            <div className="grid grid-cols-1 pb-8 text-center">
                <h3 className="mb-4 md:text-3xl text-2xl md:leading-snug leading-snug font-semibold">Learn More About Allocator</h3>
                        ...
                        <div className="group relative overflow-hidden bg-white dark:bg-slate-900 rounded-md shadow dark:shadow-gray-700 hover:shadow-md transition-all duration-500" key={item.id}>
                            ...
                            <div className="relative p-6">
                                ...
                                <div className="">
                                    ...
                                    <div className="flex mb-4">
                                        <span className="text-slate-400 text-[16px] flex items-center">
                                            <LuCalendarDays className="text-slate-900 dark:text-white me-2" />
                                            <span>{item.date}</span>
                                        </span>

                                        <span className="text-slate-400 text-[16px] flex items-center ml-auto">
                                            <LuClock className="text-slate-900 dark:text-white me-2 text-base" />
