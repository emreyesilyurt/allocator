...
//                             <li><Link href="/blogs" className="sub-menu-item">Learn</Link></li>
...
//                     {/* Avatar Dropdown (No fake data, placeholders only) */}
//                     <div className="relative">
//                         <button
//                             onClick={() => openDropdown(!isDropdown)}
//                             className="btn btn-icon rounded-full bg-violet-600 hover:bg-violet-700 border-violet-600 hover:border-violet-700 text-white inline-flex"
//                             type="button"
//                         >
//                             <Image
//                                 src="/images/default-avatar.png" // placeholder avatar
//                                 width={38}
//                                 height={38}
...
//                         <div
//                             className={`dropdown-menu absolute end-0 m-0 mt-4 z-10 w-56 rounded-md overflow-hidden bg-white dark:bg-slate-900 shadow dark:shadow-gray-800 ${isDropdown ? 'hidden' : 'block'}`}
//                         >
//                             <div className="relative">
...
//                                         className="inline-flex items-center text-[14px] font-semibold py-1.5 px-4 hover:text-violet-600"
//                                     >
...
//                                         className="inline-flex items-center text-[14px] font-semibold py-1.5 px-4 hover:text-violet-600"
//                                     >
//                                         <LuSettings className="text-[16px] align-middle me-1" />
//                                         Settings
//                                     </Link>
//                                 </li>
        ...
        <nav id="topnav" className="defaultscroll is-sticky">
            <div className="container flex flex-wrap items-center justify-between">
                ...
                <div className="hidden lg:flex items-center space-x-6 mx-auto">
                    <Link href="/aboutus" className="sub-menu-item text-sm font-medium">About Us</Link>
                    <Link href="/blogs" className="sub-menu-item text-sm font-medium">Learn</Link>
                    <Link href="/contact" className="sub-menu-item text-sm font-medium">Contact</Link>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="relative">
                        <button
                            onClick={() => openDropdown(!isDropdown)}
                            className="btn btn-icon rounded-full bg-violet-600 hover:bg-violet-700 text-white"
                        >
                            <Image
                                src="/images/default-avatar.png"
                                width={38}
                                ...
                                <div className="absolute px-4 -bottom-7 left-0">
                                    <div className="flex items-end">
                                        <Image
                                            ...
                                            width={38}
                                            height={38}
                                            className="rounded-full w-10 h-10 shadow dark:shadow-gray-700"
                                            alt=""
                                        />
                                        <span className="font-semibold text-[15px] ms-1">User Name</span>
                                    </div>
                    ...
                    <Link
                        href="/signup"
                        className="inline-flex items-center px-4 py-2 text-sm font-semibold bg-violet-600 hover:bg-violet-700 text-white rounded-full"
                    >
                        Try it Free
                    </Link>
                </div>
