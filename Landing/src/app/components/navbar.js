...
//                             <li><Link href="/wallet" className="sub-menu-item">Learn</Link></li>
...
//                         <Link
//                             href="/login"
//                             className="btn border border-gray-200 text-black font-medium hover:bg-gray-100 dark:bg-slate-900 dark:border-gray-800 dark:text-white dark:hover:bg-slate-800 rounded-full px-5 py-2"
//                         >
//                             Login
//                         </Link>
...
//                         <Link
//                             href="/signup"
//                             className="btn bg-violet-600 hover:bg-violet-700 text-white font-medium rounded-full px-5 py-2"
//                         >
//                             Sign Up
//                         </Link>
//                     </div>
            ...
            <nav id="topnav" className="defaultscroll is-sticky">
                <div className="container flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        <Link
                            href="/login"
                            className="px-6 py-1.5 text-[15px] font-semibold border border-gray-300 text-black dark:text-white rounded-full hover:bg-gray-100 dark:hover:bg-slate-800"
                        >
                            Login
                        </Link>
                        <Link
                            href="/signup"
                            className="px-4 py-1.5 text-[15px] font-semibold bg-violet-600 hover:bg-violet-700 text-white rounded-full"
                        >
                            Sign Up
                        </Link>
                    </div>
                    ...
                    {/* Commented buttons for future reuse */}
                    {/*
                    <ul className="buy-button list-none mb-0">
                        <li className="inline-block mb-0">
                            <div className="form-icon relative">
