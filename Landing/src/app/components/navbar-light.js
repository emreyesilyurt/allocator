                    ...
                    <Link className="logo ps-0" href="/">
                        ...
                        <div className="sm:block hidden">
                            <span className="inline-block dark:hidden">
                                <Image src="/images/logo-dark.png"  width={116} height={28} className="l-dark" alt=""   />
                                <Image src="/images/logo-light.png" width={116} height={28} className="l-light" alt=""   />
                            </span>
                            <Image src="/images/logo-white.png"  width={116} height={28} className="hidden dark:inline-block" alt=""  />
                        </div>
                    </Link>
                                ...
                                <div className="relative">
                                    ...
                                    <div className="absolute px-4 -bottom-7 start-0">
                                        <div className="flex items-end">
                                            <Image src="/images/client/05.jpg"  width={38} height={38} className="rounded-full size-10 shadow dark:shadow-gray-700" alt=""  />
