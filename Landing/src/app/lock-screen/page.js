                    ...
                    <div className="flex justify-center">
                        <div className="max-w-[400px] w-full m-auto p-6 bg-white dark:bg-slate-900 shadow-md dark:shadow-gray-800 rounded-md">
                            <div className="text-center">
                                <Image src='/images/client/05.jpg' placeholder='blur' blurDataURL='/images/client/05.jpg' className="mx-auto size-28 rounded-full shadow dark:shadow-gray-800" alt="" width={112} height={112}   />
