            ...
            <div className="container relative z-1">
                <div className="grid grid-cols-1">
                    <div className="title-heading text-center my-auto">
                        ...
                        <div className="mt-6">
                            <Link href="/" className="btn bg-violet-600/5 hover:bg-violet-600 border-violet-600/10 hover:border-violet-600 text-violet-600 hover:text-white rounded-full">Back to Home</Link>
                        </div>
                    </div>
                </div>
            </div>
