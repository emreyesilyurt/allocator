                    ...
                    <div className="grid lg:grid-cols-12 gap-6 mt-6">
                        ...
                        <div className="xl:col-span-4 lg:col-span-12">
                            <div className="grid xl:grid-cols-1 lg:grid-cols-2 gap-6">
                                ...
                                <div className="relative overflow-hidden rounded-lg border border-gray-100 dark:border-gray-800 bg-white dark:bg-slate-900">
