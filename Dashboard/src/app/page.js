...
//      <div className={`page-wrapper bg-white dark:bg-black dark:bg-black ${toggle ? "toggled" : ""}`}>

//          <Navbar/>
//          {/*<main className='page-content bg-white dark:bg-black dark:bg-black'>*/}
//          {/*<main className='page-content bg-white dark:bg-black dark:bg-black min-h-screen'>*/}
//          <main className='page-content bg-black text-white'>
...
//                                 <div className="relative overflow-hidden rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-black dark:bg-black p-2">
...
//                                                     <div className="group relative overflow-hidden p-2 rounded-lg bg-white dark:bg-black dark:bg-black border border-gray-100 dark:border-gray-800 hover:shadow-md dark:shadow-md hover:dark:shadow-gray-700 transition-all duration-500 hover:-mt-2 h-fit">
...
//                                 <div className="relative overflow-hidden rounded-lg border border-gray-100 dark:border-gray-800 bg-white dark:bg-black dark:bg-black">
...
//                                                         <Link href="" className="btn btn-sm bg-gray-800/5 hover:bg-gray-800/10 dark:bg-gray-800 dark:hover:bg-gray-600 border border-gray-800/5 dark:border-gray-800 text-slate-900 dark:text-white rounded-full">{item.follow}</Link>
//                                                     </li>
//                                                 )
//                                             })}
//                                         </ul>
...
//                                                                 <span className="btn btn-sm bg-gray-800/5 hover:bg-gray-800/10 dark:bg-gray-800 dark:hover:bg-gray-600 border border-gray-800/5 dark:border-gray-800 text-slate-900 dark:text-white rounded-full sm:inline-flex hidden"><i className="mdi mdi-lightning-bolt"></i> Bid Now</span>

//                                                                 <span className="btn btn-icon btn-sm rounded-full bg-gray-800/5 hover:bg-gray-800/10 dark:bg-gray-800 dark:hover:bg-gray-600 border border-gray-800/5 dark:border-gray-800 text-slate-900 dark:text-white sm:hidden inline-flex"><i className="mdi mdi-lightning-bolt"></i></span>
//                                                             </Link>
//                                                             <Link href="#" className="btn btn-icon btn-sm rounded-full bg-gray-800/5 hover:bg-gray-800/10 dark:bg-gray-800 dark:hover:bg-gray-600 border border-gray-800/5 dark:border-gray-800 text-slate-900 dark:text-white"><i className="mdi mdi-plus"></i></Link>
//                                                         </span>
//                                                     </li>
//                                                 )
//                                             })}
