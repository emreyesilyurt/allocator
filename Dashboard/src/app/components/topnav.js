...
import { Menu, Bell, ShoppingCart, DollarSign, Truck } from 'react-feather'
                                ...
                                <ul className="py-2 text-start h-64 border-t border-gray-100 dark:border-gray-800" >
                                    <li>
                                        <Link href="#"  className="block font-medium py-1.5 px-4">
                                            <div className="flex">
                                                <div className="size-10 rounded-full shadow shadow-violet-600/10 dark:shadow-gray-700 bg-violet-600/10 dark:bg-black text-violet-600 dark:text-white flex items-center justify-center">
                                    ...
                                    <li>
                                        <Link href="#" className="block font-medium py-1.5 px-4">
                                            <div className="flex">
                                                <Image src="/images/client/04.jpg" width={40} height={40} className="size-10 rounded-full shadow dark:shadow-gray-700" alt=""/>
                                                <div className="ms-2">
                                    ...
                                    <li>
                                        <Link href="#" className="block font-medium py-1.5 px-4">
                                            <div className="flex">
                                                <Image src="/images/client/05.jpg" width={40} height={40} className="size-10 rounded-full shadow dark:shadow-gray-700" alt=""/>
                                                <div className="ms-2">
