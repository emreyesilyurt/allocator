                ...
                <div className="container-fluid relative px-3">
                    <div className="layout-specing">
                        <div className="md:flex justify-between items-center">
                            <h5 className="text-lg font-semibold">Probably A Label #3277</h5>
                        ...
                        <div className="grid lg:grid-cols-12 md:grid-cols-2 grid-cols-1 gap-6 mt-6">
                            <div className="lg:col-span-5">
                                <Image src='/images/items/1.jpg' width={0} height={0} sizes="100vw" placeholder="blur" blurDataURL="/images/items/1.jpg" className="rounded-md shadow dark:shadow-gray-700 w-full h-auto" alt=""/>
                                    ...
                                    <div className="md:w-1/2">
                                        <div className="flex items-center">
                                            <div className="relative inline-block">
                                                <Image src='/images/avatar/1.jpg' width={64} height={64} placeholder="blur" blurDataURL="/images/avatar/1.jpg" className="h-16 rounded-md" alt=""/>
                                    ...
                                    {activeIndex === 1 ?
                                        ...
                                        <div>
                                            <div className="grid grid-cols-1">
                                                <div className="flex items-center">
                                                    <div className="relative inline-block">
                                                        <Image src='/images/items/1.gif' width={80} height={64} placeholder="blur" blurDataURL='/images/items/1.gif' className="h-20 rounded-md" alt=""/>
                                                        <i className="mdi mdi-check-decagram text-emerald-600 text-lg absolute -top-2 -end-2"></i>
                                                    </div>
